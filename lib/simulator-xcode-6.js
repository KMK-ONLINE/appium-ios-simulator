...
import { default as xcode } from 'appium-xcode';
...
class SimulatorXcode6 extends EventEmitter {
  ...
  async run (startupTimeout = this.startupTimeout, allowTouchEnroll = false) {
    ...
    // await exec('fbsimctl', ['shutdown'])
    await exec('fbsimctl', args, {timeout: OPEN_TIMEOUT});
